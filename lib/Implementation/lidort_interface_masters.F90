...
subroutine lcs_masters_m_lcs_master_wrap (lidort_fixin_in, &
                                          lidort_modin_in, &
                                          lidort_sup_in, &
                                          lidort_out_in, &
                                          lidort_linfixin_in, &
...
subroutine lps_masters_m_lps_master_wrap (lidort_fixin_in, &
                                          lidort_modin_in, &
                                          lidort_sup_in, &
                                          lidort_out_in, &
                                          lidort_linfixin_in, &
...
subroutine masters_m_master_wrap (lidort_fixin_in, &
                                  lidort_modin_in, &
                                  lidort_sup_in, &
