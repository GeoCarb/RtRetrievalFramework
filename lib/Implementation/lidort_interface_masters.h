...
extern "C" {
  ...
  void lcs_masters_m_lcs_master_wrap(void** lidort_fixin_in, void** lidort_modin_in, void** lidort_sup_in, void** lidort_out_in, void** lidort_linfixin_in, void** lidort_linmodin_in, void** lidort_linsup_in, void** lidort_linout_in);
}
...
public:
  ...
  void run() {
    ...
    lcs_masters_m_lcs_master_wrap(&lidort_fixin_lcl, &lidort_modin_lcl, &lidort_sup_lcl, &lidort_out_lcl, &lidort_linfixin_lcl, &lidort_linmodin_lcl, &lidort_linsup_lcl, &lidort_linout_lcl);
...
extern "C" {
  ...
  void lps_masters_m_lps_master_wrap(void** lidort_fixin_in, void** lidort_modin_in, void** lidort_sup_in, void** lidort_out_in, void** lidort_linfixin_in, void** lidort_linmodin_in, void** lidort_linsup_in, void** lidort_linout_in);
}
...
public:
  ...
  void run() {
    ...
    lps_masters_m_lps_master_wrap(&lidort_fixin_lcl, &lidort_modin_lcl, &lidort_sup_lcl, &lidort_out_lcl, &lidort_linfixin_lcl, &lidort_linmodin_lcl, &lidort_linsup_lcl, &lidort_linout_lcl);
...
extern "C" {
  ...
  void masters_m_master_wrap(void** lidort_fixin_in, void** lidort_modin_in, void** lidort_sup_in, void** lidort_out_in);
}
...
public:
  ...
  void run() {
    ...
    masters_m_master_wrap(&lidort_fixin_lcl, &lidort_modin_lcl, &lidort_sup_lcl, &lidort_out_lcl);
...
extern "C" {
  void brdf_sup_accessories_m_read_wrap(const char* filename, const int* filename_len, void** brdf_sup_out_in, void** lidort_fixin_in, void** lidort_modin_in, void** lidort_sup_in);
  void brdf_sup_accessories_m_write_wrap(const char* filename, const int* filename_len, void** brdf_sup_out_in, void** lidort_fixin_in, void** lidort_modin_in, void** lidort_sup_in);
...
public:
  Lidort_Brdf_Sup_Accessories(boost::shared_ptr<Lidort_Fixed_Inputs>& lidort_fixin_in, boost::shared_ptr<Lidort_Modified_Inputs>& lidort_modin_in) : lidort_fixin_(lidort_fixin_in), lidort_modin_(lidort_modin_in) 
  { 
  ...
  void read_fortran_file(const std::string& filename_in) {
    ...
    brdf_sup_accessories_m_read_wrap(filename_lcl, &filename_in_len, &brdf_sup_out_lcl, &lidort_fixin_lcl, &lidort_modin_lcl, &lidort_sup_lcl);
  ...
  void write_fortran_file(const std::string& filename_in) {
    ...
    brdf_sup_accessories_m_write_wrap(filename_lcl, &filename_in_len, &brdf_sup_out_lcl, &lidort_fixin_lcl, &lidort_modin_lcl, &lidort_sup_lcl);
