...
use lidort_intensity_m
use lidort_lc_wfatmos_m
use lidort_ls_wfsurface_m
...
subroutine brdf_sup_accessories_m_read_wrap (filename_in, filename_in_len, brdf_sup_out_in, &
                                             lidort_fixin_in, &
                                             lidort_modin_in, &
  ...
  call lidort_brdf_sup_accessories_m_read(filename_lcl, brdf_sup_out_lcl, &
                                          lidort_fixin_lcl, &
                                          lidort_modin_lcl, &
                                          lidort_sup_lcl)
...
subroutine lidort_brdf_sup_accessories_m_read (filename, brdf_sup_out_in, &
                                               lidort_fixin_in, &
                                               lidort_modin_in, &
                                               lidort_sup_in) 
  ! Arguments
...
subroutine brdf_sup_accessories_m_write_wrap (filename_in, filename_in_len, brdf_sup_out_in, &
                                              lidort_fixin_in, &
                                              lidort_modin_in, &
                                              lidort_sup_in) bind(c)
  ...
  call lidort_brdf_sup_accessories_m_write(filename_lcl, brdf_sup_out_lcl, &
                                           lidort_fixin_lcl, &
                                           lidort_modin_lcl, &
                                           lidort_sup_lcl)
...
subroutine lidort_brdf_sup_accessories_m_write (filename, brdf_sup_out_in, &
                                                lidort_fixin_in, &
                                                lidort_modin_in, &
                                                lidort_sup_in) 
  ! Arguments
