...
BOOST_AUTO_TEST_CASE(lidort_pars)
{
  ...
  BOOST_CHECK_EQUAL(tst_obj.lidort_version_number, "3.8.1");
  ...
  BOOST_CHECK_EQUAL(tst_obj.maxstreams, 12);
  ...
  BOOST_CHECK_EQUAL(tst_obj.max_user_obsgeoms, 4);
  ...
  BOOST_CHECK_EQUAL(tst_obj.bpdfsoil_idx, 10);
  BOOST_CHECK_EQUAL(tst_obj.bpdfvegn_idx, 11);
  BOOST_CHECK_EQUAL(tst_obj.bpdfndvi_idx, 12);
  BOOST_CHECK_EQUAL(tst_obj.newcmglint_idx, 13);
  BOOST_CHECK_EQUAL(tst_obj.rtkhotspot_idx, 14);
  BOOST_CHECK_EQUAL(tst_obj.modfresnel_idx, 15);
  BOOST_CHECK_EQUAL(tst_obj.maxbrdf_idx, tst_obj.modfresnel_idx);
...
BOOST_AUTO_TEST_CASE(brdf_sup_outputs)
{
  ...
  BOOST_CHECK_EQUAL(tst_obj.bs_wsa_kernels().extent(0), lid_pars.3);
  BOOST_CHECK_EQUAL(tst_obj.bs_bsa_kernels().extent(0), lid_pars.3);
...
BOOST_AUTO_TEST_CASE(lidort_linatmos)
{
  ...
  BOOST_CHECK_EQUAL(tst_obj.ts_albmed_fluxes_profwf().extent(0), lid_pars.2);
  ...
  BOOST_CHECK_EQUAL(tst_obj.ts_trnmed_fluxes_profwf().extent(0), lid_pars.2);
  ...
  BOOST_CHECK_EQUAL(tst_obj.ts_albmed_fluxes_colwf().extent(0), lid_pars.2);
  BOOST_CHECK_EQUAL(tst_obj.ts_albmed_fluxes_colwf().extent(1), lid_pars.max_atmoswfs);
  BOOST_CHECK_EQUAL(tst_obj.ts_trnmed_fluxes_colwf().extent(0), lid_pars.2);
...
BOOST_AUTO_TEST_CASE(lidort_main_outputs)
{
  ...
  BOOST_CHECK_EQUAL(tst_obj.ts_albmed_fluxes().extent(0), lid_pars.2);
  BOOST_CHECK_EQUAL(tst_obj.ts_trnmed_fluxes().extent(0), lid_pars.2);
...
BOOST_AUTO_TEST_CASE(lidort_modified_uservalues)
{
  ...
  BOOST_CHECK_EQUAL(tst_obj.ts_user_obsgeom_input().extent(0), lid_pars.max_user_obsgeoms);
  BOOST_CHECK_EQUAL(tst_obj.ts_user_obsgeom_input().extent(1), lid_pars.3);
  ...
  blitz::Array<double, 2> ts_user_obsgeom_input_exp(tst_obj.ts_user_obsgeom_input().shape());
  ts_user_obsgeom_input_exp = 0;
  BOOST_CHECK_MATRIX_CLOSE_TOL(tst_obj.ts_user_obsgeom_input(), ts_user_obsgeom_input_exp, 1e-10);
