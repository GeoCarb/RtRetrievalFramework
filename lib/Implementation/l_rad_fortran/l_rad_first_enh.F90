module l_rad_first_enh_m

USE l_surface_m
USE l_sscorr_outgoing_m
...
! factor (set to 1.d0 for including shadowing).
      ...
      subroutine L_rad_first_enh &
       (nlay,nstokes,nfine,nfinedivs,surftype, & !inputs
        ...
        emu0,theta,phi,heights,NCrit,xfine,wfine,csqfine,cotfine, & !I
        Raycon,cota,sunpaths,ntraverse,sunpaths_fine,ntraverse_fine, & !I
        R1,Ls_R1,L_R1) !O
...
!  Get the exact first-order calculation
      ...
      call L_SSCORR_OUTGOING &
           (nlay,nfine,nfinedivs,nstokes, & !I
            ...
            L_allb_i, L_alla_i, & !I
            L_allb, L_alla, &
            emu0,heights,NCrit,xfine,wfine,csqfine,cotfine, & !I
            Raycon,cota,sunpaths,ntraverse,sunpaths_fine,ntraverse_fine, & !I
...
!  Finish
      ...
      return
      end subroutine L_rad_first_enh

end module l_rad_first_enh_m
