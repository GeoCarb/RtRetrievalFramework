...
subroutine SFO_LPS_MASTER &
       ( maxgeoms, maxszas, maxvzas, maxazms, maxlayers, maxpartials, maxfine, maxmoments_input, & ! Input max dims
         ...
         cumtrans, LP_cumtrans, Master_fail, message, trace_1, trace_2 )                           ! Output (Exception handling)
...
!  Spherical functions call. Updated 9/17/16.
       ...
       Call FO_ScalarSS_spherfuncs &
               ( MAXMOMENTS_INPUT, MAXGEOMS, STARTER, DO_SPHERFUNC, &
...
subroutine SFO_LCS_MASTER &
       ( maxgeoms, maxszas, maxvzas, maxazms, maxlayers, maxpartials, maxfine, maxmoments_input, & ! Input max dims
         ...
         Cumtrans, LC_cumtrans, Master_fail, message, trace_1, trace_2 )                           ! Output (Exception handling)
