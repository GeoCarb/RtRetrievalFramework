...
!  5/5/20. Version 3.8.1 Upgrades. Direct-Thermal upgrade. 
...
!  - 4/9/19. Add the CUMTRANS output, add water-leaving control
       ...
       Call SS_Integral_I_UP &
        ( maxgeoms, maxlayers, maxpartials, maxfine, maxmoments_input, max_user_levels,  & ! Inputs (dimensioning)
          ...
          ngeoms, nlayers, nfinedivs, nmoments_input, n_user_levels, user_level_mask_up, & ! Inputs (control)
          ...
          intensity_up, intensity_db, SScumsource_up, Cumtrans )                           ! Outputs
