...
subroutine SS_Integral_I_UP &
      ( maxgeoms, maxlayers, maxpartials, maxfine, maxmoments_input, max_user_levels,  & ! Inputs (dimensioning)
        ...
        intensity_up, intensity_db, cumsource_up, cumtrans )                             ! Outputs
...
!     Check for updating the recursion. RobFix 8/17/16 Partials.
      ...
      DO UTA = N_USER_LEVELS, 1, -1
         ...
         DO N = NSTART, NUT, -1
            NC = NLAYERS + 1 - N
            CUMSOURCE_DB_START = CUMSOURCE_DB_START * LOSTRANS_UP(N)
...
subroutine SS_Integral_I_UPDN   &
   ( maxgeoms, maxlayers, maxpartials, maxfine, maxmoments_input, max_user_levels,     & ! Inputs (dimensioning)
     ...
     intensity_up, intensity_db, cumsource_up, intensity_dn, cumsource_dn, cumtrans )                ! Outputs
