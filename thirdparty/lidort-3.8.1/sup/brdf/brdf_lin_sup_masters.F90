...
! #####################################################################
      ...
      USE LIDORT_pars_m, Only : MAX_BRDF_KERNELS, MAX_BRDF_PARAMETERS, MAXSTREAMS_BRDF, MAXBRDF_IDX, &
                                ...
                                ROSSTHIN_IDX, ROSSTHICK_IDX, RTKHOTSPOT_IDX, LISPARSE_IDX, LIDENSE_IDX,      &
...
!mick fix 3/22/2017 - moved user-stream IF condition from before reading user viewing
!                     angle inputs to here
...
!mick fix 3/22/2017 - moved user-stream IF condition from here to before reading azimuth
!                     angle inputs
