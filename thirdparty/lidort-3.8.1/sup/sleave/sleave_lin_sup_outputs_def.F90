...
module SLEAVE_Lin_Sup_Outputs_def_m
...
use LIDORT_PARS_m, Only : fpk, MAXSTREAMS, MAXMOMENTS, MAXBEAMS, &
                          MAX_USER_STREAMS, MAX_USER_RELAZMS, MAX_SLEAVEWFS
...
!mick fix 7/20/2016 - removed as an output variable: strictly an input now
...
end module SLEAVE_Lin_Sup_Outputs_def_m
