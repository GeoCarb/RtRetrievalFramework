...
subroutine Phasfunc_HenGreen &
   ( max_moms, max_geoms, max_szas, max_vzas, max_azms,   & ! input  Dimensions (LIDORT)
     do_upwelling, do_dnwelling, do_ObsGeoms, do_derivs,  & ! input  Flags
     n_moms, n_geoms, n_szas, n_vzas, n_azms,             & ! input  Numbers
     offsets, dtr, szas, vzas, azms, obsgeoms, Asymm,     & ! Input  Geometries + Asymm
