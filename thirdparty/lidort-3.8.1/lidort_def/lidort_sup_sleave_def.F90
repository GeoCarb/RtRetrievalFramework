...
!    ###################################################################
      ...
      MODULE LIDORT_Sup_SLEAVE_def_m
...
!                          Intent(Out) for LIDORT SleaveSup
      ...
      USE LIDORT_PARS_m, only : fpk, MAXBEAMS, MAX_USER_STREAMS, &
...
!  Exact Surface-Leaving term
      ...
      REAL(fpk), dimension ( MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS ) :: TS_SLTERM_USERANGLES

!  Fourier components of Surface-leaving terms:
!    Every solar direction, SL-transmitted quadrature streams
!    Every solar direction, SL-transmitted user streams

      REAL(fpk), dimension ( 0:MAXMOMENTS, MAXSTREAMS,       MAXBEAMS ) :: TS_SLTERM_F_0
      REAL(fpk), dimension ( 0:MAXMOMENTS, MAX_USER_STREAMS, MAXBEAMS ) :: TS_USER_SLTERM_F_0
...
!  EVERYTHING PUBLIC HERE
      ...
      END MODULE LIDORT_Sup_SLEAVE_def_m
