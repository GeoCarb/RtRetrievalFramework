...
!      LIDORT_Sup_SS_def  Intent(InOut)
      ...
      USE LIDORT_PARS_m, only : fpk, MAX_USER_LEVELS, MAX_GEOMETRIES, &
                                MAX_DIRECTIONS
...
!  SS Intensity Results at all angles and optical depths
      ...
      REAL(fpk), dimension ( MAX_USER_LEVELS, MAX_GEOMETRIES, MAX_DIRECTIONS ) :: TS_INTENSITY_SS

!  DB Intensity Results at all angles and optical depths

      REAL(fpk), dimension ( MAX_USER_LEVELS, MAX_GEOMETRIES ) :: TS_INTENSITY_DB
...
!  EVERYTHING PUBLIC HERE
      ...
      end module LIDORT_Sup_SS_def_m
