...
!  Version 3.8.1, Upgrade June 2019
      ...
      MODULE LIDORT_Lin_Sup_SLEAVE_def_m
...
!                             Intent(Out) for LIDORT LinSleaveSup
      ...
      use LIDORT_PARS_m, only : fpk, MAXMOMENTS, MAXSTREAMS, MAX_USER_RELAZMS, &
                                MAX_SLEAVEWFS, MAXBEAMS, MAX_USER_STREAMS
...
!  Isotropic Surface leaving term (if flag set)
      ...
      REAL(fpk), dimension ( MAX_SLEAVEWFS, MAXBEAMS ) :: TS_LSSL_SLTERM_ISOTROPIC

!  Exact Surface-Leaving term

      REAL(fpk), dimension ( MAX_SLEAVEWFS, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS ) :: TS_LSSL_SLTERM_USERANGLES

!  Fourier components of Surface-leaving terms:
!    Every solar direction, SL-transmitted quadrature streams
!    Every solar direction, SL-transmitted user streams

      REAL(fpk), dimension ( MAX_SLEAVEWFS, 0:MAXMOMENTS, MAXSTREAMS,       MAXBEAMS ) :: TS_LSSL_SLTERM_F_0
      REAL(fpk), dimension ( MAX_SLEAVEWFS, 0:MAXMOMENTS, MAX_USER_STREAMS, MAXBEAMS ) :: TS_LSSL_USER_SLTERM_F_0
...
!  EVERYTHING PUBLIC HERE
      ...
      END MODULE LIDORT_Lin_Sup_SLEAVE_def_m
