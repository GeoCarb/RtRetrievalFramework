...
!  New 10/25/12, Observation Geometry inputs
      ...
      LIDORT_ModIn%MUserVal%TS_USER_OBSGEOM_INPUT  = ZERO
...
!    Added, 25 October 12
!mick mod 3/22/2017 - added ELSE section
...
!  3. User defined stream (viewing) angles (should be positive)
!     ---- check not exceeding dimensioned number
...
!mick fix 6/4/2019 - added "DO_SURFACE_LEAVING" IF condition to DO_EXTERNAL_WLEAVE
      ...
      IF ( DO_SOLAR_SOURCES ) THEN
         ...
         IF ( DO_OBSERVATION_GEOMETRY ) THEN
            ...
            LIDORT_ModIn%MUserVal%TS_USER_OBSGEOM_INPUT(1:N_USER_OBSGEOMS,1:3) = &
