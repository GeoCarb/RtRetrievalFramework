...
!  Complete the multipliers
          ...
          DO Q = 1, K_PARAMETERS
            LP_UT_GMULT_DN(AA,UT,K,Q) = ITA * L_MULTDN(Q) + GDN * ( L_ITRANS(Q) + L_ATERM_SAVE(AA,N,Q) )
            LP_UT_GMULT_UP(AA,UT,K,Q) = ITB * L_MULTUP(Q) + GUP * ( L_ITRANS(Q) + L_BTERM_SAVE(AA,N,Q) )
          ENDDO
...
!  Complete the multipliers
          ...
          ITB = ITRANS * BTERM_SAVE(AA,N); GUP = UT_GMULT_UP(AA,UT)
          DO Q = 1, K_PARAMETERS
            LP_UT_GMULT_DN(AA,UT,K,Q) = ITA * L_MULTDN(Q) + GDN * L_ITRANS(Q)
            LP_UT_GMULT_UP(AA,UT,K,Q) = ITB * L_MULTUP(Q) + GUP * L_ITRANS(Q)
          ENDDO
