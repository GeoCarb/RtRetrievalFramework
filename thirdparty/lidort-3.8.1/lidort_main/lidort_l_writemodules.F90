...
!  Local variables
      ...
      INTEGER :: OUTUNIT
      INTEGER :: MOM,STRM,USTRM,IB,URA,STRMI,STRMJ,SWF
          ...
          DO MOM=0,NMOMS
            DO SWF=1,N_SURFACE_WFS
              WRITE(OUTUNIT,DWFR4) &
                ...
                ' SWF = ',SWF,&
                ' LS_BRDF_F_0(SWF,MOM,STRM,IB) = ',LS_BRDF_F_0(SWF,MOM,STRM,IB)
            END DO
          END DO
        END DO
      END DO
          ...
          DO MOM=0,NMOMS
            DO SWF=1,N_SURFACE_WFS
              WRITE(OUTUNIT,DWFR4) &
                ...
                ' SWF = ',SWF,&
                ' LS_BRDF_F(SWF,MOM,STRMI,STRMJ) = ',LS_BRDF_F(SWF,MOM,STRMI,STRMJ)
            END DO
          END DO
        END DO
      END DO
            ...
            DO MOM=0,NMOMS
              DO SWF=1,N_SURFACE_WFS
                WRITE(OUTUNIT,DWFR4) &
                  ...
                  ' SWF = ',SWF,&
                  ' LS_USER_BRDF_F_0(SWF,MOM,USTRM,IB) = ',LS_USER_BRDF_F_0(SWF,MOM,USTRM,IB)
              END DO
            END DO
          END DO
        END DO
            ...
            DO MOM=0,NMOMS
              DO SWF=1,N_SURFACE_WFS
                WRITE(OUTUNIT,DWFR4) &
                  ...
                  ' SWF = ',SWF,&
                  ' LS_USER_BRDF_F(SWF,MOM,USTRM,STRM) = ',LS_USER_BRDF_F(SWF,MOM,USTRM,STRM)
              END DO
            END DO
          END DO
        END DO
...
!
      ...
      USE LIDORT_PARS_m, Only : fpk, MAX_SLEAVEWFS, MAXMOMENTS, MAXSTREAMS, MAX_USER_STREAMS, &
                                MAX_USER_RELAZMS, MAXBEAMS, MAX_SLEAVEWFS, DWFR2, DWFR4
...
!  Local variables
      ...
      INTEGER :: OUTUNIT
      INTEGER :: SWF,MOM,STRM,USTRM,IB,URA
          ...
          DO MOM=0,NMOMS
            DO SWF=1,N_SLEAVE_WFS
              WRITE(OUTUNIT,DWFR4) &
                ...
                ' LSSL_SLTERM_F_0(SWF,MOM,STRM,IB) = ',LSSL_SLTERM_F_0(SWF,MOM,STRM,IB)
            END DO
          END DO
        END DO
      END DO
            ...
            DO MOM=0,NMOMS
              DO SWF=1,N_SLEAVE_WFS
                WRITE(OUTUNIT,DWFR4) &
                  ...
                  ' LSSL_USER_SLTERM_F_0(SWF,MOM,USTRM,IB) = ',LSSL_USER_SLTERM_F_0(SWF,MOM,USTRM,IB)
              END DO
            END DO
          END DO
        END DO
