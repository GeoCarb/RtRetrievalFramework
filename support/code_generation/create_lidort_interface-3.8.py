...
LIDORT_PARS_NAME = "lidort_pars_m"
...
BRDF_FILENAMES = (
    ("brdf_lin_sup_masters.F90", "brdf_lin_sup_masters_m"),
...
#MASTER_FILE_MODULES[os.path.join(LIDORT_BASE_DIR, 'sup/accessories/lidort_sleave_sup_accessories.F90')] = "lidort_sleave_sup_accessories_m"
...
MASTERS_IGNORE_ROUTINES = ( 'lidort_check_input_dims',
                            'lidort_check_input',
...
MASTERS_CONSTRUCTOR_ARGUMENTS["brdf_lin_sup_masters_m"] = ( 'thread' )
MASTERS_CONSTRUCTOR_ARGUMENTS["brdf_sup_masters_m"] = ( 'thread' )
MASTERS_CONSTRUCTOR_ARGUMENTS["lidort_lcs_masters_m"] = ( 'thread' )
MASTERS_CONSTRUCTOR_ARGUMENTS["lidort_lps_masters_m"] = ( 'thread' )
MASTERS_CONSTRUCTOR_ARGUMENTS["lidort_masters_m"] = ( 'thread' )
MASTERS_CONSTRUCTOR_ARGUMENTS["lidort_brdf_sup_accessories_m"] = ( 'brdf_sup_in',
                                                                   'lidort_fixin',
                                                                   'lidort_modin', )
#MASTERS_CONSTRUCTOR_ARGUMENTS["lidort_sleave_sup_accessories_m"] = ( 'sleave_sup_in',
#                                                                     'lidort_fixin',
#                                                                     'lidort_modin', )
